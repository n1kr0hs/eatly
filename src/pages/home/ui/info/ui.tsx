...
export const Info: React.FC = () => {
  return (
    <section className="bg-[#6c5fbc] py-[55px] relative overflow-hidden">
      <Container>
        <ul className="flex flex-wrap justify-center">
          <li className="flex-[0_1_33.33%] px-[25px] text-center border-r border-[#c5c5c5]">
            <div className="font-publicSans text-white font-bold text-[43px] mb-[10px]">
              10K+
            </div>
            <p className="font-inter text-[#C5BFED] text-[14px] font-medium">
          ...
          <li className="flex-[0_1_33.33%] px-[25px] text-center">
            <div className="font-publicSans text-white font-bold text-[43px] mb-[10px]">
              99.99%
            </div>
            <p className="font-inter text-[#C5BFED] text-[14px] font-medium">
